...
<body>
<form name="LoginForm" action="updatecompany.jsp" method="post" onSubmit="return fu();">
 <%
 ...
 Connection con=null;
	...
	ResultSet rs=null;
	int id=0;
	String name=null,utype=null;
	String u=(String)session.getAttribute("uname");
	String p=(String)session.getAttribute("pass");
	String sql="select * from reg where email='"+u+"' && password='"+p+"'";
try
	{
...
<div align="center" id="login-box">
          ...
          <H2><font color="#66CCFF" size="4"> EDIT ACCOUNT </font></H2>
            
           
		  <div>&nbsp;</div><div>&nbsp;</div><div><table>
		   <tr>
                <td><strong><font size="2">ID</font></strong></td>
                <td>:</td><td><input  style="background-color: #000000;font: bold 12px Arial" name="id" value="<%=id%>" type="textbox" disabled="true" ></td></tr>
		  <tr><td>&nbsp;</td></tr>
		  <tr>
                <td><strong><font size="2">Company Name</font></strong></td>
                <td>:</td><td><input style="background-color: #000000;font: bold 12px Arial" name="cname" value="<%=name%>" type="text" disabled="true"></td></tr>
		  <tr><td>&nbsp;</td></tr>
		    <tr>
                <td><strong><font size="2">EmailID</font></strong></td>
                <td>:</td><td><input style="background-color: #000000;font: bold 12px Arial" name="email" value="<%=u%>" type="text" disabled="true"></td></tr>
			 <tr><td>&nbsp;</td></tr>
			 <tr>
