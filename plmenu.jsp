...
-->
	...
	<%
		String s=new String("select * from emp_details where emp_code='"+name+"'");
		try
		{
  ...
  <tr valign="top">
    <td>
      ...
      <table width="100%" height="22" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#8F9CBE">
        <tr align="center"> 
          <td width="100%"><div align="right"><a href="logout.html" ><font size="2" color="#FFFFFF">LOGOUT</font></a></div></td>
        </tr>
      </table>
</table>
<p>&nbsp;</p>
