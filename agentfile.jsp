          ...
          <div class="content-box-left-in"> 
            ...
            <div align="center" style="background-color: #D3E1ED"> 
              <table border="1" width="500" height="" cellpadding="5" cellspacing="5">
                <tr>&nbsp;</tr>
                <tr> 
                  <td  height="10" class="paragraping"><font color="#319DB0"><strong>From</strong></font></td>
                  <td  height="" class="paragraping"><font color="#319DB0"><strong>Subject</strong></font></td>
                  <td  class="paragraping"> <font color="#319DB0"><strong>FileName</strong></font></td>
                  <td  class="paragraping"> <font color="#319DB0"><strong>Date</strong></font></td>
                  <td  class="paragraping"><font color="#319DB0"> <strong>Details</strong></font></td>
                </tr>
                <%
				while(rs.next())
				{
