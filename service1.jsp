      ...
      <td height="128" style="height: 45px; background: url(images/img1.jpg);"> 
        <table width="670" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <td></td><td align="center" width="537"><p><strong><font size="+1"> <font color="#CCCCFF" size="4">&nbsp;IMPROVING 
           ...
           <p align="center"> <strong><font size="1"><a href="editaccount.jsp"> 
                Edit Account</a><font color="#CCCCFF" size="5"> </font></font></strong></p></td>     
...
<div align="center" id="login-box">
          ...
          <H2><font color="#66CCFF" size="4">SERVICES</font></H2>
            <div>&nbsp;</div><div>&nbsp;</div><div>&nbsp;</div>
            <div>&nbsp;</div><div>&nbsp;</div>
		  <div>&nbsp;</div><div>&nbsp;</div><div>&nbsp;</div>
           <div align="center" ><font size="2"><strong><a href="login.htm">Automation and Management</a></strong></font></div> 
