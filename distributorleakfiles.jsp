          ...
          <div align="center" class="content-box-left-in"> 
            ...
            <div align="center" style="background-color: #D3E1ED"> 
              <table border="1" width="500" height="" cellpadding="5" cellspacing="5">
                <tr>&nbsp;</tr>
                <tr> 
                  <td  height="" class="paragraping"><font color="#319DB0"><strong>UserName</strong></font></td>
                  <td  class="paragraping"> <font color="#319DB0"><strong>File</strong></font></td>
                  <td  class="paragraping"><font color="#319DB0"> <strong>Subject</strong></font></td>
                  <td  class="paragraping"><font color="#319DB0"> <strong>Date</strong></font></td>
                </tr>
                <%
				  while(rs.next())
				  {
				  ...
				  %>
                <tr> 
                  <td  height="" class="paragraping"><font color="#319DB0" size="2" > 
                    <%=rs1.getString(7)%>
                    </font></td>
                  <td  class="paragraping"> <font color="#319DB0" size="2" > 
                    <%=rs1.getString(4)%>
                    </font></td>
                  <td  class="paragraping"><font color="#319DB0" size="2"> 
                    <%= rs1.getString(2)%>
