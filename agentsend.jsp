            ...
            <div align="center" style="background-color: #D3E1ED"> 
              <table>
                ...
                <%
					  ...
					  %></td></tr><tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td></td><td><input style="background: url('../img/submit.jpeg')" type="submit"s name="send" value="Send" ></td><td><input style="background: url('../img/submit.jpeg')" type="reset" name="clr" value="Clear" onClick="open1()"></td></tr>
              </table>
            </div>
          </div>
        </div>
